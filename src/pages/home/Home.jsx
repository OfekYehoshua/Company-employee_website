    ...
    return(
        <div className="home">
            ...
            <div className="img-card-container">
                <Typography><h1 id="welcome">Welcom to our employee web!</h1></Typography> 
            ...
            <Typography><h1 className="pulications-title">We want to keep you updated about our actions in the society</h1></Typography> 
            <MultiActionAreaCard/>
